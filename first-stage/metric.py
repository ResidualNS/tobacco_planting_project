...
if __name__=="__main__":
    gtlist = fileList('./cvatdataset/train/gt/', '*.png')
    problist1 = fileList('./cvatdataset/train/pre1/', '*.png')
    problist2 = fileList('./cvatdataset/train/pre2/', '*.png')
    modelName=['yancao1',"yancan2"]

    drawCurve(gtlist,[problist1,problist2],modelName,'yancao')
print('0.0.0.0.0.0.0')